...
describe('favoriteReducer', () => {
  ...
  it('должен обработать setFavoriteOfferList', () => {
    const initialState = {
      favoriteOfferList: [],
      favoriteNumber: 0,
      isFavoritesLoading: false,
  ...
  it('должен обработать incrementFavoriteNumber', () => {
    const initialState = {
      favoriteOfferList: [],
      favoriteNumber: 0,
      isFavoritesLoading: false,
  ...
  it('должен обработать decrementFavoriteNumber', () => {
    const initialState = {
      favoriteOfferList: [],
      favoriteNumber: 1,
      isFavoritesLoading: false,
  ...
  it('должен обработать setFavoriteNumber', () => {
    const initialState = {
      favoriteOfferList: [],
      favoriteNumber: 0,
      isFavoritesLoading: false,
  ...
  it('должен обработать setFavoritesLoading', () => {
    const initialState = {
      favoriteOfferList: [],
      favoriteNumber: 0,
      isFavoritesLoading: false,
