...
describe('Async actions', () => {
  ...
  describe('fetchOffersAction', () => {
    it('должен отправить loadOffers и setLoadingStatus, когда сервер отвечает данными', async () => {
  ...
  describe('fetchSelectedOffer', () => {
    it('должен отправить setSelectedOffer и setLoadingStatus, когда сервер отвечает данными', async () => {
  ...
  describe('fetchReviewsList', () => {
    it('должен отправить setReviews и setReviewLoadingStatus, когда сервер отвечает данными', async () => {
  ...
  describe('sendReviewData', () => {
    it('должен отправить fetchReviewsList и setError, когда сервер отвечает данными', async () => {
  ...
  describe('fetchFavoriteOfferList', () => {
    it('должен отправить setFavoriteOfferList и setFavoriteNumber, когда сервер отвечает данными', async () => {
      const mockOffers: OfferCardData[] = [];
  ...
  describe('updateFavoriteStatus', () => {
    it('должен отправить fetchFavoriteOfferList, когда сервер отвечает данными', async () => {
  ...
  describe('sendLoginData', () => {
    it('должен отправить setAuthorizationStatus, setUserData и сохранить токен, когда сервер отвечает данными', async () => {
  ...
  describe('checkAuth', () => {
    it('должен отправить setAuthorizationStatus и setUserData, когда сервер отвечает данными', async () => {
      const mockUserData: UserData = { email: 'test@test.com', token: 'secret', name: 'Test User', avatarUrl: '', isPro: false };
  ...
  describe('logoutAction', () => {
    it('должен отправить setAuthorizationStatus и удалить токен, когда сервер отвечает данными', async () => {
    ...
    it('должен вызвать "dropToken" один раз при выполнении "logoutAction"', async () => {
